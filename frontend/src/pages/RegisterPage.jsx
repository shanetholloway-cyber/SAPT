...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/profile", { state: { user: response.data.user, isNewUser: true } });
    } catch (error) {
    ...
    <div className="min-h-screen bg-[#FAFAFA] flex">
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        <div className="absolute inset-0 bg-[#F5D5D5]">
          <img
            src="https://images.unsplash.com/photo-1691315909393-c5c91e22760f?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1MDV8MHwxfHNlYXJjaHwyfHxmaXRuZXNzJTIwYWVzdGhldGljJTIweW9nYSUyMG1hdCUyMGR1bWJiZWxscyUyMHBhc3RlbHxlbnwwfHx8fDE3Njk5Nzg4OTN8MA&ixlib=rb-4.1.0&q=85"
            alt="Fitness aesthetic"
            className="w-full h-full object-cover opacity-90"
          />
          <div className="absolute inset-0 bg-gradient-to-l from-[#F5D5D5]/30 to-transparent" />
        </div>
      </div>
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#FAFAFA] text-[#737373]">or register with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <Label htmlFor="name" className="text-[#1A1A1A] font-medium mb-1.5 block">
                Full Name
              </Label>
            ...
            <div>
              <Label htmlFor="confirmPassword" className="text-[#1A1A1A] font-medium mb-1.5 block">
                Confirm Password
              </Label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#737373]" />
          ...
          <p className="mt-8 text-center text-[#737373]">
            ...
            <Link to="/login" className="text-[#1A1A1A] font-medium hover:underline" data-testid="goto-login-link">
              Sign in
            </Link>
          </p>
        </div>
